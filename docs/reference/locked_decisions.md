...
| 23 | **Conventional Commits; every commit body + PR body ends with the `Co-authored w/ Claudio` trailer.**               | Machine-readable history; a mandatory, uniform authorship trailer (no other generated footer).                | Hard |
