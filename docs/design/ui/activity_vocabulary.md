...
Related: [_index.md](_index.md) (the visual direction and the colour rules this inherits), [live_status_transport.md](live_status_transport.md) (the polling that produces the two snapshots), [baseline_component_reporting.md](../architecture/baseline_component_reporting.md) (the component states the local half reads), [locked_decisions.md](../../reference/locked_decisions.md) (#46 the mesh-link state, #62 Material UI, #63 the 3:1 status bar, #66 infrastructure reporting).
