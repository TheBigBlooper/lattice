...
/**
 * The thin bootstrap for the orders service. As a verticle it simply deploys the
 * {@link OrdersVerticle}; as a program its {@link #main(String[])} stands up a Vert.x instance and
...
public final class MainVerticle extends VerticleBase {
    ...
    @Override
    public Future<?> start() {
        return vertx.deployVerticle(new OrdersVerticle());
    }
}
